...
# Flips all images and corresponding labels horizontally, skipping images with parking signs present.

# Input folders
root = "/home/slsecret/Downloads/bfmc_data/TestSetData"
image_dir = os.path.join(root, "rf2024", "images")
label_dir = os.path.join(root, "rf2024", "labels")

# Output folders
flipped_image_dir = os.path.join(root, "rf2024_flipped", "images")
flipped_label_dir = os.path.join(root, "rf2024_flipped", "labels")
