...
base_path = args.path
image_folder = os.path.join(base_path, "dataset/images/train/")
label_folder = os.path.join(base_path, "dataset/labels/train/")

print("image_folder: ", image_folder)

# Get the list of label files
label_files = [f for f in os.listdir(label_folder) if f.endswith(".txt") and f.startswith("track")]

# Define the class names and corresponding colors
class_names = ["oneway", "highwayentrance", "stop", "roundabout", "parking", "crosswalk", "noentry", "highwayexit", "prio", "light", "block", "girl", "car"]
